...
```{r, "ages", warning = FALSE, echo = FALSE, fig.pos='htb', fig.align='center', out.width="5.5in", fig.cap = paste0("Example age-frequency plot for ", sp,". Male fish are shown in the top plot as green coloured circles and female fish are shown in the bottom plot as purple coloured circles. The grey circles represent age data from sorted specimens in both the male and female plots. Diagonal lines are shown at five-year intervals to facilitate tracing cohorts through time.")}
